...
final buildMessagesStreamProvider =
...
class ChatController {
  ...
  Future<UserModel> fetchUserDetailsWithUid(String uid) async {
    ...
    return UserModel.fromSnapshot(
        res as DocumentSnapshot<Map<String, dynamic>>);
  }
  ...
  Future<AdvertisementModel> getAdvertisementById(String id) async {
    ...
    final adDoc =
        doc.docs.map((e) => AdvertisementModel.fromSnapShot(e)).single;
    return adDoc;
  }

  Future<void> initiateChat(
      String sellerId, String buyerId, String itemId) async {
